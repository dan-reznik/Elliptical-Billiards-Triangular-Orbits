...
knitr::include_graphics("pics/ellipse_equation.png")
```

* The law of reflection:

```{r,echo=F,out.width="50%"}
knitr::include_graphics("pics/law_of_reflection.png")
```
...
knitr::include_graphics("pics/e1e2_intersection.png")
```
...
```{r,echo=F,out.width="75%"}
knitr::include_graphics("pics/anticomplementary_and_medial_circumbilliards.png")
```
...
```{r,echo=F,out.width="75%"}
knitr::include_graphics("pics/darboux_line.png")
```
...
```{r,echo=F,out.width="75%"}
knitr::include_graphics("pics/peter_moses_points.png")
```
...
```{r,echo=F,out.width="50%"}
knitr::include_graphics("pics/isotomic_isogonal_axes.png")
```
